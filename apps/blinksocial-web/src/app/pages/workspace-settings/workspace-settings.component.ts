...
export class WorkspaceSettingsComponent implements OnInit {
  ...
  readonly tabs: TabDef[] = [
    ...
    { id: 'content', label: 'Content', saveLabel: 'Save Content Strategy', icon: 'M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.84zM22 17.65l-9.17 4.16a2 2 0 0 1-1.66 0L2 17.65M22 12.65l-9.17 4.16a2 2 0 0 1-1.66 0L2 12.65' },
