...
const HIVE_ITEMS: ContentItem[] = [
  ...
  { id: 'concept1', stage: 'concept', status: 'draft', title: 'Morning Mobility Flow for Stiff Joints', description: 'Quick morning mobility routine targeting stiff joints and tight muscles. Walks through a 60-second daily reset you can do before coffee.', hook: 'Your body shouldn\'t feel 80 when you\'re 30. Try this 60-second morning reset.', objective: 'engagement', pillarIds: ['p1'], segmentIds: ['s4'], productionTargets: [{ platform: 'instagram', contentType: 'reel' }, { platform: 'tiktok', contentType: 'short-video' }], createdAt: '2026-02-20T07:00:00', updatedAt: '2026-02-24T14:00:00' },
  { id: 'concept2', stage: 'concept', status: 'draft', title: 'Anti-Inflammatory Smoothie Recipes', description: '3 quick smoothie recipes packed with turmeric, ginger, and berries for reducing inflammation. Ready in under 5 minutes, no expensive supplements needed.', hook: 'These 3 ingredients fight inflammation better than most supplements.', objective: 'education', pillarIds: ['p4'], segmentIds: ['s5', 's2'], productionTargets: [{ platform: 'instagram', contentType: 'carousel' }, { platform: 'youtube', contentType: 'shorts' }], createdAt: '2026-02-19T10:00:00', updatedAt: '2026-02-23T16:00:00' },
