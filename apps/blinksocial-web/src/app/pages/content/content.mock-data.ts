...
const HIVE_ITEMS: ContentItem[] = [
  { id: 'idea1', stage: 'idea', status: 'draft', title: 'Chair Yoga Series for Office Workers', description: '5-part series showing simple yoga stretches that can be done at a desk or with a chair.', pillarIds: ['p1', 'p2'], segmentIds: ['s1', 's2'], createdAt: '2026-02-28T09:00:00', updatedAt: '2026-02-28T09:00:00' },
  ...
  { id: 'idea3', stage: 'idea', status: 'draft', title: 'Breathwork 101: 3 Techniques for Stress Relief', description: 'Simple breathwork tutorial showing three foundational breathing techniques.', pillarIds: ['p1', 'p5'], segmentIds: ['s3', 's5'], createdAt: '2026-02-28T11:00:00', updatedAt: '2026-02-28T11:00:00' },
  ...
  { id: 'concept1', stage: 'concept', status: 'draft', title: 'Morning Mobility Flow for Stiff Joints', description: 'Quick morning mobility routine targeting stiff joints and tight muscles.', hook: 'Your body shouldn\'t feel 80 when you\'re 30. Try this 60-second morning reset.', objective: 'engagement', pillarIds: ['p1'], segmentIds: ['s4'], createdAt: '2026-02-20T07:00:00', updatedAt: '2026-02-24T14:00:00' },
  { id: 'concept2', stage: 'concept', status: 'draft', title: 'Anti-Inflammatory Smoothie Recipes', description: '3 quick smoothie recipes packed with turmeric, ginger, and berries for reducing inflammation.', hook: 'These 3 ingredients fight inflammation better than most supplements.', objective: 'education', pillarIds: ['p4'], segmentIds: ['s5', 's2'], createdAt: '2026-02-19T10:00:00', updatedAt: '2026-02-23T16:00:00' },
